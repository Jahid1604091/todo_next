...
import {BiEdit, BiEditAlt, BiPlus} from 'react-icons/bi'
...
export default function UpdateUserForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="grid lg:grid-cols-2 w-5/6 gap-4">
            ...
            <button className="flex justify-center text-md w-2/6 bg-green-500 text-white p-1 rounded-md "><BiEdit size={23}/> Update</button>
        </form>
    )
}
